      ...
      items: [
        ...
        },
        {
          ...
          details: [
            ...
            "Developed software integration including Handlebars.js and WordPress.js",
            "Created e-mail marketing design templates using Handlebars for E-mails",
            "Customized the blog CSS and Javascript with built-in theme for better UX of the site",
          ],
        ...
        },
        {
          ...
          details: [
            "Created the main site navigation (image, menu, mobile drawer) using Tailwind CSS",
            "Revamped shopping cart & checkout experience including 8 pages in total",
            "Created e-mail marketing design templates using Handlebars",
          ],
          icon: <Code className="w-4 h-4" />,
        },
      ],
